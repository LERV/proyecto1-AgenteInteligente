...
#------------------------------------------------------------
# Number of properties for using the algorithm

n = 7 # horizontal size of the map
m = 7 # vertical size of the map
the_map = []
row = [1] * n
...
#-----------------------------
print("MAPA INGRESADOOOOOOOOOOOOOOOOO")
for yy in range(m):
    print(the_map[yy])
...
(xA, yA, xB, yB) = (1,1,5,4) #This post cant be in the map as Obstacle
